...
function Terminal() {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ padding: 24, background: bg, fontFamily: 'monospace', fontSize: 13 }}>
        {lines.map((l, i) => (
          <div key={i} style={{ color: l.startsWith('>') ? gold : text }}>{l}</div>
        ))}
        {lines.length < cmds.length && <span style={{ color: goldLight }}>█</span>}
      </div>
    </div>
  );
}
...
function Card({ icon, title, desc }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 16, fontWeight: 600, color: goldLight, marginBottom: 8 }}>{title}</div>
  ...
  return (
    <div style={{ minHeight: '100vh', background: bg, color: .#FFFFFF. }}>
      ...
      <nav style={{
        ...
        <span style={{ fontFamily: 'monospace', fontSize: 13, color: goldLight, letterSpacing: '0.3em' }}>[ VAANI ]</span>
      ...
      <section style={{
        ...
        padding: '80px 24px 24px', background: bg,
      }}>
        <pre style={{
          fontFamily: 'monospace', lineHeight: 1.2, color: goldLight,
        ...
        <p style={{ fontSize: 11, color: goldLight, letterSpacing: '0.2em', marginTop: 32, textTransform: 'uppercase' }}>
          Select Language
        </p>
      ...
      <div style={{
        ...
        maxWidth: 800, margin: '0 auto', padding: '48px 24px', background: bg, background: bg,
        borderTop: `1px solid ${gold}33`, borderBottom: `1px solid ${gold}33`,
        textAlign: 'center',
      }}>
        {[['2.5L+', 'Users'], ['₹500Cr+', 'Managed'], ['22', 'Languages']].map(([v, l], i) => (
          <div key={i}>
            <div style={{ fontSize: 36, fontWeight: 700, color: goldLight, textShadow: `0 0 20px ${gold}40` }}>{v}</div>
      ...
      <section id="features" style={{ padding: '80px 24px', background: bg }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <h2 style={{ fontSize: 28, fontWeight: 700, textAlign: 'center', marginBottom: 8 }}>
            Built for <span style={{ color: goldLight }}>India.</span>
          </h2>
      ...
      {/* Demo */}
      <section id="demo" style={{ padding: '80px 24px', background: bg, background: bg }}>
        <div style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8 }}>
            <span style={{ color: goldLight }}>See it live</span>
          </h2>
      ...
      <footer style={{
        ...
        <span style={{ fontFamily: 'monospace', fontSize: 12, color: goldLight, letterSpacing: '0.2em' }}>VAANI v2.0</span>
