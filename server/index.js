...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.groq.com", "https://api.minimax.chat", "https://api.minimax.io", "https://api.elevenlabs.io", "https://generativelanguage.googleapis.com", "http://localhost:*"],
      mediaSrc: ["'self'", 'blob:'],
